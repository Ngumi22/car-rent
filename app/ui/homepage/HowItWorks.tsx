...
export default function HowItWorks() {
  return (
    <section
      id="howitworks"
      className="grid place-content-center h-100 m-10 p-5">
      <div className="w-1/2 grid place-content-center m-auto">
        <h1 className="text-[40px] font-bold m-auto py-5 underline underline-offset-[8px]">
          How It Works
        </h1>
        <p className="m-auto">
      ...
      <div className="flex flex-col w-full my-10 gap-4 sm:flex-row items-center justify-center">
        {cards.map((card, index) => (
          <div
            ...
            <span className="absolute -bottom-7 p-3 border-2 border-blue-600 text-black rounded-full bg-blue-600">
              {card.num}
            </span>
          </div>
        ))}
